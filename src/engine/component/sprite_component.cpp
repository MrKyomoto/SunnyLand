...
{
    void SpriteComponent::setSpriteByID(const std::string &texture_id, const std::optional<SDL_FRect> &source_rec_opt)
    {
    ...
    void SpriteComponent::setSourceRect(const std::optional<SDL_FRect> &source_rec_opt)
    {
        sprite_.setSourceRect(source_rec_opt);
